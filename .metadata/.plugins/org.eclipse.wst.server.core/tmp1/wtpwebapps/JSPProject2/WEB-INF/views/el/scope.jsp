...
<body>
    ...
    <pre>
    	...
    	2. request : 요청 받은 페이지(Servlet/JSP)혹은 
    				요청을 위임받은 페이지 (Servlet/JSP)에서만 사용가능
    					(최소 2페이지 이상)
    ...
    <ul>
    	<li>
    		...
    		->page scope pageMsg : 페이지 범위입니다.
    	</li>
    	<li>
    		request scope message : ${message}
    		->request scope message : request scope에 저장된 메세지 입니다.
    	</li>
    	<li>
    		session scope sessionValue : ${sessionValue}
    		->session scope sessionValue : 999
    	</li>
    	<li>
    		application scope appValue : ${appValue}
    		->application scope appValue : 애플리케이션 범위 값
    	</li>
    </ul>
    <hr>
    <h1>우선 순위 확인 : ${str}</h1>
